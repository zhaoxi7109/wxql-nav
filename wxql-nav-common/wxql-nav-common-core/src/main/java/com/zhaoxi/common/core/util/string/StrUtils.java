package com.zhaoxi.common.core.util.string;
...
public class StrUtils extends StringUtils {
    ...
    /**
     * 转换文本, {} 表示占位符，例：
     * format("欢迎访问{blogName}博客，网站地址：{siteUrl}", "万相千络", "http://zhaoxi.icu/wxql-nav")
     * format("欢迎访问{}博客，网站地址：{}", "万相千络", "http://zhaoxi.icu/wxql-nav")
     *
     * @param str    需要转换的字符串
     * @param params 参数
     */
