/*
 ...
 Source Schema         : wxql_nav

 Target Server Type    : MySQL
 Target Server Version : 80012
 File Encoding         : 65001

 Date: 15/09/2023 12:55:51
*/
...
CREATE TABLE `log_operation`  (
  ...
  `ip_address` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '操作 ip 地址',
...
CREATE TABLE `nav_category`  (
  ...
  `category_icon` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '分类图标',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '导航分类' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `nav_category` VALUES (150725316141101052, 0, 0, '热门导航', 'cc-thumbs-up', '2021-03-27 00:34:10', '2023-09-15 12:47:52', 1, 43728307660783616, 1);
...
CREATE TABLE `nav_comment`  (
  ...
  `nick_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '昵称',
...
CREATE TABLE `nav_picture`  (
  ...
  `picture_original_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '图片原名称',
  `picture_path` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '图片路径',
  `picture_md5` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '图片 md5',
  `fk_create_user_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人用户 id',
  `gmt_create` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `fk_modify_user_id` bigint(20) NULL DEFAULT NULL COMMENT '修改人用户 id',
  `gmt_modify` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '导航图片' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of nav_picture
-- ----------------------------
INSERT INTO `nav_picture` VALUES (194530308903665664, 'blob', '/profile/avatar/2023/09/13/63873936-6dda-488e-ac67-bdbe3ba7d083.jpeg', '2c7070791ef04fb2980cfcf43607edc6', 43728307660783616, '2023-09-13 19:14:00', NULL, NULL);
INSERT INTO `nav_picture` VALUES (194530497773174784, 'blob', '/profile/avatar/2023/09/13/0b18e4b1-10e5-4564-9643-c8f6aa3c7723.jpeg', '81249350a4481897ea02a7f043dd4745', 43728307660783616, '2023-09-13 19:14:45', NULL, NULL);
...
CREATE TABLE `nav_site`  (
  ...
  `site_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '网站名称',
  `site_path` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '网站图片路径',
  `site_description` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '网站描述',
  `site_url` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '网站地址',
  `sort` int(11) NULL DEFAULT 0 COMMENT '排序',
  ...
  `status` tinyint(1) NULL DEFAULT 1 COMMENT '状态（1 正常，2 停用）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户导航网站信息' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `nav_site` VALUES (150725316141100334, 150725316141101032, 'Java知音', '/profile/site/system/bbe364f9-0c94-4f88-a4ad-2b590064d624.jpeg', '一个专注于Java技术分享的网站', 'https://www.javazhiyin.com/', 7, 1, '2020-08-18 21:50:19', NULL, 1, NULL, 1);
...
INSERT INTO `nav_site` VALUES (150725316141100578, 150725316141101008, '微软官方系统', '/profile/site/system/b066263b-a469-4fa1-a1dc-df8f86869eb8.png', '正版官方下载', 'https://www.microsoft.com/zh-cn/software-download/', 13, 2, '2023-02-18 19:49:50', NULL, 1, NULL, 1);
...
CREATE TABLE `nav_site_config`  (
  ...
  `about_site_description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '关于本站描述',
  `about_site_email` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '关于本站邮箱',
  `about_site_content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '关于本站内容',
  ...
  `gmt_modify` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '网站配置' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of nav_site_config
-- ----------------------------
INSERT INTO `nav_site_config` VALUES (152819881111191552, '这个导航网站源码来源于格姗导航的开源项目。由于个人技术有限，并未作过多修改，如果你有更好的想法，可以通过左边的邮箱与我联系。如果喜欢本站，可以分享给其他人，或者设置为主页，这是对我最大的支持！\'', '2997605126@qq.com', '<p>这是一个导航网站,收录了大部分常用的网站，希望能够解决到你频繁收藏网站的烦恼！</p><p>显然，这是一个开源项目，主要放一些自己经常用到的网站。</p><p>开源项目来源：<a href=\"\\\" target=\"\\\">https://gitee.com/zhaoxi7109/wxql-nav</a></p>', 21, 43728307660783616, '2023-05-21 16:51:39', 43728307660783616, '2023-09-13 19:12:05');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (43728307660783616, 'admin', '管理员', '$2a$10$uYSATn7m4cmLFtr4uz7rs.W8a0s3EbwZJCyGnthUrZacMgKh4GoIG', 1, 1, '2997605126@qq.com', '', '/profile/avatar/2023/09/13/0b18e4b1-10e5-4564-9643-c8f6aa3c7723.jpeg', 1, '我是管理员', 1, 43728307660783616, '2022-07-24 16:02:02', 43728307660783616, '2023-09-13 19:19:56');
INSERT INTO `sys_user` VALUES (43767104519798784, 'zhaoxi', '昭晞', '$2a$10$rm5jwWc6lRM11Q.OOEH2T.t41GnkzITcvVAI19LdAicn5/AJdD0im', 2, 1, '2997605126@qq.com', '', '', 1, '', 1, 43728307660783616, '2022-07-24 18:34:51', 43728307660783616, '2023-09-13 19:08:49');
